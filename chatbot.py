 ...
 "Here are the Top Colleges in Pune through CET EXAMINATION: <br> 1.COEP Pune <br> 2.MIT World Peace University, Pune <br> 3.MKSSS's Cummins College of Engineering for Women,Pune  <br> 4.Vishwakarma Institue of Technology, Pune  <br> 5.MIT Academy of Engineering, Pune <br> 6.MIT-WPU Faculty of Engineering,Pune <br> 7.PICT Pune <br> 8.JSPM Narhe Technical Campus,Pune <br> 9.IIT Pune <br> 10.DPCOE ,Pune </b>",
  ...
  "In Maharashtra, the following communities are considered as minorities for the purpose of admission to engineering colleges through CET (Common Entrance Test): <br>Muslim <br>Christian <br>Sikh <br>Buddhist <br>Jain <br>Parsi <br>Other notified minorities (such as Jews) <br>These communities are eligible for minority quota seats in engineering colleges in Maharashtra. However, the exact number of seats and the admission criteria may vary from college to college.It's important to note that to be eligible for the minority quota, candidates must belong to the specific community and should provide valid proof of the same. Candidates can check with the individual colleges for more information on the admission process and the availability of minority quota seats.</b>", 
   ...
   "The cut-off scores for engineering colleges in Maharashtra through CET (Common Entrance Test) vary from year to year depending on a variety of factors such as the number of applicants, the difficulty level of the exam, and the number of seats available. Here are the cut-off scores for some of the top engineering colleges in Maharashtra through CET in the previous year: <br> <br>1.College of Engineering, Pune (COEP) - 95.9 percentile <br>2.Veermata Jijabai Technological Institute (VJTI), Mumbai - 94.3 percentile <br>3.Sardar Patel College of Engineering (SPCE), Mumbai - 91.9 percentile <br>4.Institute of Chemical Technology (ICT), Mumbai - 89.7 percentile <br>4.Dwarkadas J. Sanghvi College of Engineering (DJ Sanghvi), Mumbai - 87.2 percentile <br>5.Thadomal Shahani Engineering College (TSEC), Mumbai - 85.6 percentile <br>6.Fr. Conceicao Rodrigues College of Engineering (CRCE), Mumbai - 83.7 percentile <br>7.Vishwakarma Institute of Technology (VIT), Pune - 82.6 percentile <br>8.Pimpri Chinchwad College of Engineering (PCCOE), Pune - 78.2 percentile <br>9.KJ Somaiya College of Engineering (KJSCE), Mumbai - 77.2 percentile <br> <br> Please note that these cut-off scores are for the previous year, and the actual cut-off scores may vary for the current year. Also, it's important to note that the cut-off scores may vary depending on the category of the candidate, such as General, SC, ST, OBC, etc. </b>",
    ...
    "1",
     "<b> ● Print out of counselling registration form <br> <br> ● MHT CET admit card and Result <br> ● Class 10 and 12 pass certificate and marksheet <br> ● Category certificate (if applicable) <br> ● Character and migration certificate <br> ● School leaving certificate <br> ● Domicile certificate (if applicable) <br> Press 0 to Exit </b>",
    
    "2",
    "<b> Following are the frequently asked questions during admission <br> <br> 2.1 What is Freeze <br> 2.2 What is Slide <br> 2.3 What is Float <br> 2.4 What is Merit List <br> 2.5 What is CET in engineering? <br> 2.6 Who is eligible to take the CET exam for engineering <br> 2.7 What is the application process for CET? <br> 2.8 What is the syllabus for CET? <br> 2.9 How is the CET exam conducted? <br> 2.10 What is the selection process after CET? <br> Press 0 to Exit </b>",
    
    "2.1",
    " <b> What is Freeze : <br> Candidates who are satisfied with their allotted seats and do not want to participate in further have to select this option. <br> By selecting this option candidates will confirm their allotted seats and will not be allowed to participate further <br> Press 0 to Exit</b>",
    
    "2.2",
    " <b> What is Slide : <br> By selecting this option candidates who wish to accept the seat allotted to them but will also be open for upgradation into a higher preferred course in the same institute. <br> If in further round these candidates are allotted in a higher preferred course then their previous seat will be cancelled <br> Press 0 to Exit </b>",
   
    "2.3",
    "<b> What is Float : <br> This option allows candidates to upgrade their seat to a higher preferred choice of course at any institute. <br> However their earlier allotment will be cancelled if their choice of higher course is allotted to them.<br> Press 0 to Exit </b> ",
  
    "2.4",
    "<b>  What is Merit List : <br> After the declaration of result the exam conducting authority releases the provisional merit list in online mode. <br> The merit will be prepared based on the marks secured in the entrance exam. <br> The provisional merit list carries the name of candidates shortlisted for counselling along with their overall ranks. <br> To check the merit list candidates have to login into their account by entering application number and date of birth. <br> What needs to be noted is that separate merit list is prepared and released for JEE Main qualified candidates. <br> MHT CET merit list will be available separately for different groups like all India and Maharashtra candidates. <br> A few days window will be given to the candidates to send the complaint against the merit list if they have any. <br> After the feedback a final merit list will be published.<br> Press 0 to Exit </b> ",
    
    "2.5",
    "<b>  What is CET in engineering? : <br> CET stands for Common Entrance Test for engineering. It is a competitive exam conducted by various state-level and national-level authorities to provide admission to undergraduate engineering courses in various colleges and universities across India.<br> Press 0 to Exit </b>",

    "2.6",
    " <b> Who is eligible to take the CET exam for engineering? : <br> The eligibility criteria for CET vary from state to state, but in general, candidates who have completed their 10+2 education with Physics, Chemistry, and Mathematics as compulsory subjects are eligible to appear for the exam.<br> Press 0 to Exit</b>",

    "2.7",
    " <b>  What is the application process for CET? : <br> The application process for CET involves registering online on the official website of the exam conducting authority. Candidates need to provide their personal and educational details, upload their photograph and signature, and pay the application fee. The application process usually starts a few months before the exam date.<br> Press 0 to Exit</b>",

    "2.8",
    " <b>  What is the syllabus for CET?: <br> The syllabus for CET includes topics from Physics, Chemistry, and Mathematics that are covered in the 10+2 education. The level of difficulty and the weightage of each topic may vary depending on the state and the conducting authority.<br> Press 0 to Exit</b>",

    "2.9",
    " <b>  How is the CET exam conducted?: <br> The CET exam is usually conducted in an online mode (computer based) and has multiple-choice questions. The duration of the exam is typically 3 hours, and there is no negative marking for wrong answers like JEE and NEET entrance exams.<br> Press 0 to Exit</b>",
 
    "2.10",
    "<b>  What is the selection process after CET?:  <br> The selection process after CET involves counseling rounds based on the candidate's rank in the exam. Candidates need to register for counseling, and seats are allotted based on their preferences and availability.<br> Press 0 to Exit</b>",
    
    "3",
    "<b > Scholarship related information <br> <br> 3.1 Government Scholarships? <br> 3.2 Private Scholarships? <br> 3.3 Merit-based Scholarships? <br> 3.4 Need-based Scholarships? <br> 3.5 Sports Scholarships? <br> Press 0 to Exit</b>",
    
    "3.1",
    " <b> Government Scholarships? : <br> Government Scholarships: Various government departments offer scholarships for engineering students. These scholarships are usually based on academic performance, and other criteria such as financial need, minority status, and disability. Some popular government scholarships for engineering students in India include the INSPIRE Scholarship, Jindal Scholarship, and Sitaram Jindal Scholarship.<br> Press 0 to Exit</b>",

    "3.2",
    " <b> Private Scholarships? : <br> Many private companies and organizations offer scholarships for engineering students based on academic merit, financial need, and other criteria. Some of the well-known private scholarships for engineering students include the Tata Scholarship, L&T Build India Scholarship, and Samsung Star Scholarship.<br> Press 0 to Exit</b>",

    "3.3",
    " <b> Merit-based Scholarships? : Many colleges and universities offer merit-based scholarships for engineering students who have excelled academically. These scholarships are usually awarded based on the student's CET rank, and they can cover a percentage of tuition fees or the full tuition fees.<br> Press 0 to Exit<b/>",
    ...
    "5.5",
    " <b> Percentile Between 41 to 50: <br> If you have scored between 41 and 50 percentile in CET (Common Entrance Test) in Maharashtra, it may be very challenging to secure admission in most of the engineering colleges. However, there are still some engineering colleges that you can consider applying to. Here are some of the engineering colleges in Maharashtra that you may consider: <br> Shri Ramdeobaba College of Engineering and Management, Nagpur <br>GH Raisoni College of Engineering, Nagpur <brPune Institute of Computer Technology (PICT), Pune<br>Pimpri Chinchwad College of Engineering (PCCOE), Pune <br>Dr DY Patil Institute of Engineering, Management and Research (DYPIEMR), Pune <br>D Y Patil College of Engineering and Technology, Kolhapur <br>Annasaheb Dange College of Engineering and Technology, Sangli <br>Sharad Institute of Technology, College of Engineering, Yadrav <br>Shreeyash College of Engineering and Technology, Aurangabad <br>Jaihind College of Engineering, Pune <br> <br>These colleges offer decent education and infrastructure, and have a good track record in terms of placements. However, the admission process and cut-off scores may vary for each college, and it's important to check the individual college websites for more information on their admission criteria, eligibility, and cut-off scores. You should also consider factors such as location, cost, campus facilities, and placement opportunities before making your final decision.<br> Press 0 to Exit </b>",
    ...
    "6",
    " <b> Forms <br> 6.1 MHT CET Application Form <br> 6.2 CAP Registration Form<br> 6.3 Option Form <br> 6.4 Press 0 to Exit </b>",

    "6.1",
    "<b> Application Form: The MHT CET application form is the primary form that you need to fill to apply for admission to various undergraduate engineering, pharmacy, and agricultural courses offered by colleges in Maharashtra. <br> <br> These are the steps for filling the application form: <br> <br>Step 1: Registration <br> Visit the official website of the MHT CET and click on the registration link. Fill in your basic details like name, date of birth, email ID, mobile number, etc. to register for the exam. After filling the details, click on the 'Submit' button. <br> <br> Step 2: Fill Application Form <br> After registration, login to the portal using the username and password generated at the time of registration. Fill in all the required details in the application form like personal information, academic qualification, contact details, etc. <br> <br>Step 3: Upload Documents After filling in the details, you need to upload the scanned copies of your recent passport-sized photograph and signature in the prescribed format. Also, upload your 10th and 12th mark sheet and other relevant documents. <br> <br> Step 4: Pay Application Fee After filling in all the details and uploading the documents, you need to pay the application fee. The fee can be paid online using a debit card, credit card, or net banking. Make sure to take a printout of the fee receipt for future reference. <br> <br>Step 5: Submit Application Form After paying the application fee, review all the details filled in the form and make changes if required. Once you are satisfied with the details, click on the 'Submit' button to complete the application process. <br> <br>Step 6: Download Admit Card After successfully submitting the application form, you will receive the admit card on the registered email ID. Download and take a printout of the admit card for the exam day. <br> <br> I hope these steps will help you fill the MHT CET application form. Good luck with your application and the exam!<br> Press 0 to Exit </b>",

    "6.2",
    "<b> CAP Registration Form:  <br> <br> I can guide you on how to fill the CAP registration form for MHT CET. <br> <br>  Here are the steps: <br> <br> Visit the official website of the Directorate of Technical Education (DTE), Maharashtra, and click on the Admissions tab.Click on the CAP Round Registration link and select the Undergraduate option for the desired academic year.Read the instructions carefully and click on the New Registration button to proceed.Enter your personal and contact details, including name, date of birth, mobile number, email ID, etc. and create a password for your account.Click on the Save and Next button to proceed to the next section.Enter your academic details, such as the qualifying exam board, subject, percentage/CGPA, and other relevant information.Enter your domicile status and reservation category, if applicable.Upload the necessary documents, such as the photograph, signature, and other supporting documentsPreview the application form and make sure that all the information entered is correct.Click on the Submit button to submit the application form.Pay the application fee online using a debit card, credit card, or internet banking.Take a printout of the application form for future reference.That's it! You have successfully filled the CAP registration form for MHT CET. Make sure to keep a copy of the application form and payment receipt for future reference. Also, please note that the above steps are indicative, and the actual steps may vary based on the current admission guidelines and instructions issued by DTE Maharashtra.<br> Press 0 to Exit </br>",

    "6.3",
    "<b> The option form for MHT-CET is filled online by candidates who have successfully cleared the entrance exam. Here are the steps to fill the option form in MHT-CET: <br> <br> Visit the official website of the MHT-CET counselling process. <br>Click on the link to fill the option form. <br>Login to the website using your registration number and password. <br>Read the instructions carefully and then proceed to fill the form.<br>Select your preferred colleges and courses from the list provided.<br>The order of preference is important, so make sure you prioritize your choices accordingly.<br>Once you have filled in all the required details, review your choices carefully and make sure you have not made any mistakes.<br>Submit the form and take a printout of it for future reference.<br>Wait for the seat allotment process to begin.<br>If you are allotted a seat in one of your preferred colleges, you will receive an intimation through email or SMS.<br>You will have to report to the allotted college within the given time frame and complete the admission process.<br> Press 0 to exit </br>",

    "6.4",
    "<b> The seat acceptance process for MHT-CET is also done online by candidates who have been allotted a seat through the option form. Here are the steps to fill the seat acceptance form in MHT-CET:<br><br>Visit the official website of the MHT-CET counselling process.<br>Click on the link to fill the seat acceptance form.<br>Login to the website using your registration number and password.<br>Check the details of the seat allotted to you.<br>If you are satisfied with the seat allotment, click on the Accept button.<br>If you want to participate in further rounds of counselling, click on the Freeze button.<br>If you are not satisfied with the seat allotted to you, click on the Reject button.<br>If you have accepted the seat, you will have to pay the admission fees through the online payment mode provided on the website.<br>Download and take a printout of the seat acceptance letter.<br>Report to the allotted college within the given time frame and complete the admission process.<br> <br> Note: It is important to carefully read and understand the instructions before filling the seat acceptance form. Also, make sure you have all the required documents and the admission fees ready before starting the process.</br>",
    
    "0",
    "<b> Go ahead and write the number of any query. 😃✨ <br>1.list of important documents you will be needing to complete your admission process.</br>2.Frequently asked questions regarding admission </br>3.Scholarship related info</br>4.Top Colleges</br>5.Engineering Colleges as per your CET Percentile</br>6.Forms <br> 0. Press 0 for the main Query <br> </br>",
...
while True:
    ...
    if float(bot_response.confidence) > 0.5:
        ...
        print("Bot: Go ahead and write the number of any query. 😃✨ <br> 1.list of important documents you will be needing to complete your admission process.</br>2.Frequently asked questions regarding admission </br>3.Scholarship related info </br> 4.Top Colleges</br> </br> 5.Engineering Colleges as per your CET Percentile </br> 6.Forms <br> 0. Press 0 for the main Query <br> </br>")
